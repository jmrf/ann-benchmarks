...
from ann_benchmarks.algorithms.definitions import list_algorithms
...
def main():
    ...
    parser.add_argument(
        "--cpu-number", type=positive_int, help="specify cpu number", default=0
    )
    ...
    if not args.local:
        ...
        if {d.docker_tag for d in definitions}.difference(docker_tags):
